...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "WordsWave — Gamified Vocabulary & Language Learning"
  const description = config.description ?? "WordsWave is a gamified vocabulary and language learning app. Build your word power daily through interactive quizzes, streak tracking, leaderboards, and achievements alongside Fin, your personal dolphin guide."
